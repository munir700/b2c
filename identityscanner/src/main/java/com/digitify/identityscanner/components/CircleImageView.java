...
public class CircleImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            color = a.getColor(R.styleable.CircleImageView_ci_color, color);
            pressedRingWidth = (int) a.getDimension(R.styleable.CircleImageView_ci_pressedRingWidth, pressedRingWidth);
            a.recycle();
        }
