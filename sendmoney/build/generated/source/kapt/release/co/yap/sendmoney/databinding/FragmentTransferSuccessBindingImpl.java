...
public class FragmentTransferSuccessBindingImpl extends FragmentTransferSuccessBinding implements co.yap.sendmoney.generated.callback.OnClickListener.Listener {
    ...
    private FragmentTransferSuccessBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback36 = new co.yap.sendmoney.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        java.lang.String viewModelParentViewModelTransferDataSourceCurrencyJavaLangStringStringExtensionsKtToFormattedCurrencyViewModelParentViewModelTransferDataTransferAmount = null;
        ...
        java.lang.String stringExtensionsKtToFormattedCurrencyViewModelParentViewModelTransferDataTransferAmount = null;
        ...
        if ((dirtyFlags & 0x7ffL) != 0) {
            ...
            if ((dirtyFlags & 0x41aL) != 0) {
                ...
                if ((dirtyFlags & 0x412L) != 0) {
                        ...
                        // read StringExtensionsKt.toFormattedCurrency(viewModel.parentViewModel.transferData.getValue().transferAmount)
                        stringExtensionsKtToFormattedCurrencyViewModelParentViewModelTransferDataTransferAmount = co.yap.yapcore.helpers.extentions.StringExtensionsKt.toFormattedCurrency(viewModelParentViewModelTransferDataTransferAmount);
                        // read (viewModel.parentViewModel.transferData.getValue().sourceCurrency) + (" ")
                    ...
                    if((dirtyFlags & 0x412L) != 0) {
                        ...
                        // read ((viewModel.parentViewModel.transferData.getValue().sourceCurrency) + (" ")) + (StringExtensionsKt.toFormattedCurrency(viewModel.parentViewModel.transferData.getValue().transferAmount))
                        viewModelParentViewModelTransferDataSourceCurrencyJavaLangStringStringExtensionsKtToFormattedCurrencyViewModelParentViewModelTransferDataTransferAmount = (viewModelParentViewModelTransferDataSourceCurrencyJavaLangString) + (stringExtensionsKtToFormattedCurrencyViewModelParentViewModelTransferDataTransferAmount);
        ...
        if ((dirtyFlags & 0x412L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvAmount, viewModelParentViewModelTransferDataSourceCurrencyJavaLangStringStringExtensionsKtToFormattedCurrencyViewModelParentViewModelTransferDataTransferAmount);
        ...
        if ((dirtyFlags & 0x400L) != 0) {
            ...
            this.confirmButton.setOnClickListener(mCallback36);
        }
        if ((dirtyFlags & 0x611L) != 0) {
            // api target 1
