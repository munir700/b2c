...
public class FragmentInternationalFundsTransferBindingImpl extends FragmentInternationalFundsTransferBinding implements co.yap.sendmoney.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.clFTSnackbar, 18);
        sViewsWithIds.put(R.id.ly_internationalTransfer, 19);
        sViewsWithIds.put(R.id.rlPicture, 20);
        sViewsWithIds.put(R.id.rlAddNewProfilePic, 21);
        sViewsWithIds.put(R.id.etAmountLayout, 22);
        sViewsWithIds.put(R.id.etBeneficiaryAmountLayout, 23);
        sViewsWithIds.put(R.id.ly_YapRate, 24);
        sViewsWithIds.put(R.id.layoutReasonsSpinner, 25);
        sViewsWithIds.put(R.id.breakLine, 26);
    }
    // views
    @NonNull
    ...
    private FragmentInternationalFundsTransferBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 6
            ...
            , (co.yap.widgets.CoreButton) bindings[17]
        ...
        mCallback10 = new co.yap.sendmoney.generated.callback.OnClickListener(this, 3);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4000L) != 0) {
            ...
            this.btnNext.setOnClickListener(mCallback10);
            ...
            this.ivSelector.setOnClickListener(mCallback9);
            ...
            co.yap.yapcore.binders.UIBinder.setText(this.mboundView16, co.yap.translation.Strings.screen_international_funds_transfer_display_text_note);
            this.tvSelectReason.setOnClickListener(mCallback8);
        }
        if ((dirtyFlags & 0x6041L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x5041L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView15, viewModelStateTransferFeeSpannable);
        }
        if ((dirtyFlags & 0x4141L) != 0) {
            // api target 1
