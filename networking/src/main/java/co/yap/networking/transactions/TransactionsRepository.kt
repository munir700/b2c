...
object TransactionsRepository : BaseRepository(), TransactionsApi {
    ...
    override suspend fun checkCoolingPeriodRequest(coolingPeriodRequest: CoolingPeriodRequest): RetroApiResponse<PaymentPurposeResponseDTO> =
        executeSafely(call = { api.checkCoolingPeriodRequest(coolingPeriodRequest) })
