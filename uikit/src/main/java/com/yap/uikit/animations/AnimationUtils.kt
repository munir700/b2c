...
import com.yap.uikit.animations.animators.*
...
object AnimationUtils {
     ...
     */
    fun runTogether(vararg animator: android.animation.Animator): AnimatorSet =
        AnimatorSet().apply { playTogether(*animator) }

    /**
     * Run a set of Animators in sequence
     */
    fun runSequentially(vararg animator: android.animation.Animator): AnimatorSet =
    ...
    fun startAnimation(context: Context, view: View, animation: Int) {
        val animShake = loadAnimation(context, animation)
