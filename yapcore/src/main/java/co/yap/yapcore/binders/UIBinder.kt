...
object UIBinder {
    ...
    @JvmStatic
    @BindingAdapter(value = ["componentDialerError", "isScreenLocked"], requireAll = false)
    fun setDialerError(view: CoreDialerPad, error: String?, isScreenLocked: Boolean = false) {
