...
object RequestCodes {
    ...
    const val REQUEST_CAMERA_PERMISSION: Int = 10017
    const val REQUEST_FOR_ADDITIONAL_REQUIREMENT = 10018
    const val REQUEST_Y2Y_TRANSFER: Int = 10019
    const val REQUEST_NOTIFICATION_FLOW: Int = 10020
    const val REQUEST_CARD_ADDED: Int = 10021
    const val REQUEST_ADD_RECEIPT = 10022
    const val REQUEST_DELETE_RECEIPT = 10023
    const val REQUEST_CODE_CREATE_PASSCODE: Int = 10024
    const val REQUEST_STORAGE_PERMISSION: Int = 10024
