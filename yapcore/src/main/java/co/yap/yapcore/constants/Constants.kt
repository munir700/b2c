...
object Constants {
    ...
    const val ENABLE_RMT_SWIFT_FEATURE =
        "SYSTEM_CONFIGURATION_ENABLE_RMT_SWIFT_FEATURE"
    const val SYSTEM_CONFIGURATION_ENABLE_FSS_TIME_OUT =
        "ENABLE_ENABLE_FSS_TIME_OUT"
    const val SYSTEM_CONFIGURATION_MINIMUM_SALARY = "MINIMUM_SALARY"
    const val SYSTEM_CONFIGURATION_DEFAULT_SALARY = "DEFAULT_SALARY"
    const val SYSTEM_CONFIGURATION_MINIMUM_CASH_DEPOSIT =
        "MINIMUM_CASH_DEPOSIT"
    const val SYSTEM_CONFIGURATION_EID_DEFAULT_CASH_DEPOSIT =
        "DEFAULT_CASH_DEPOSIT"
    const val SYSTEM_CONFIGURATION_ENABLE_PASSPORT_AMENDMENT =
        "ENABLE_PASSPORT_AMENDMENT"
    const val SYSTEM_CONFIGURATION_EID_EXPIRE_LIMIT_DAYS =
        "EID_EXPIRE_LIMIT_DAYS"
}
