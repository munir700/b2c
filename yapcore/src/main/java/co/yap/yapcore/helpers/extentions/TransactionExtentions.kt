            ...
            TransactionStatus.FAILED.name -> {
                ...
                TransactionLabelsCode.IS_REFUND -> R.drawable.ic_refund
                    ...
                    when {
                        ...
                        TransactionProductCode.INWARD_REMITTANCE.pCode == transaction.productCode ?: "" || TransactionProductCode.LOCAL_INWARD_TRANSFER.pCode == transaction.productCode ?: "" -> {
