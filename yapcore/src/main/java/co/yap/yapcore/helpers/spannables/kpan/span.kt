...
class Span(val parent: Span? = null) : SpannableStringBuilder() {
    ...
    @ColorInt
    var backgroundColor: Int? = parent?.backgroundColor

    @Dimension(unit = Dimension.PX)
    var textSize: Int? = parent?.textSize
...
fun Span.quote(
    @ColorInt color: Int, text: CharSequence = "",
    init: Span.() -> Unit = {}
): Span = apply {
    append(Span(parent = this).apply {
        this.text = text
...
fun Span.image(
    drawable: Drawable, alignment: String = "bottom",
    init: Span.() -> Unit = {}
): Span = apply {
