...
object StringUtils {
    ...
    fun validateName(name: String): Boolean {
        ...
        var isValid = false
        val expression =
            "^[a-zA-ZáâäæããåāÀÁÂÄÆÃÅĀçćčÇĆČèéêëēėęÈÉÊËĒĖĘîïíīįìÎÏÍĪĮÌłŁñńÑŃôöòóœøōõÔÖÒÓOŒØŌÕßśšŚŠûüùúūÛÜÙÚŪÿŸžźżŽŹŻ]{1}[a-zA-Z.áâäæããåāÀÁÂÄÆÃÅĀçćčÇĆČèéêëēėęÈÉÊËĒĖĘîïíīįìÎÏÍĪĮÌłŁñńÑŃôöòóœøōõÔÖÒÓOŒØŌÕßśšŚŠûüùúūÛÜÙÚŪÿŸžźżŽŹŻ ]{1,100}\$"
        inputStr = name
