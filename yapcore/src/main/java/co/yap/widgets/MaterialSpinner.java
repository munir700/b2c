...
public class MaterialSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setBackgroundResource(R.drawable.bg_material_spinner);
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        int defaultErrorColor = context.getColor(R.color.error);
        ...
        disabledColor = context.getColor(R.color.grey);
        ...
        boldTypeface = ResourcesCompat.getFont(context, R.font.roboto_regular);
    ...
    private void initDimensions() {
        ...
        minContentHeight = (int) getResources().getDimension(R.dimen.margin_medium_large);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (error != null && enableErrorLabel) {
            ...
            int startYErrorLabel = startYLine + errorLabelSpacing + lineHeight + 10;
            paint.setColor(errorColor);
            paint.setTypeface(boldTypeface);
            textPaint.setColor(errorColor);
            textPaint.setTypeface(boldTypeface);
            textPaint.setTextSize(hintTextSize - 5);
            paint.setTextSize(hintTextSize - 5);
            //Error Label Drawing
            if (multiline) {
                canvas.save();
    ...
    public void setAlignLabels(boolean alignLabels) {
        ...
        rightLeftSpinnerPadding = alignLabels ? getResources().getDimensionPixelSize(R.dimen.margin_normal) : 0;
        invalidate();
    }
    ...
    private class HintAdapter extends BaseAdapter {
        ...
        public Object getItem(int position) {
            position = hint != null ? position : position;
