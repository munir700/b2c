...
class CoachMarkOverlay : FrameLayout {
    ...
    class Builder(private val mContext: Context) {
        ...
        private var mOverlayTransparentShape: ShapeType = ShapeType.RECTANGLE
        //        private var mOverlayTransparentShape: ShapeType = ShapeType.RECTANGLE
        private var mOverlayTransparentCircleRadius: Float = 0f
        private var mOverlayTransparentCornerRadius: Float = 150f
        private var mOverlayTransparentGravity: Gravity = Gravity.CENTER
        private var mOverlayTransparentMargin: Rect = Rect()
        private var mOverlayTransparentPadding: Rect = Rect(50,50,50,50)
        ...
        fun getOverlayTransparentShape(): ShapeType = mOverlayTransparentShape
        ...
        fun getOverlayTransparentPadding(): Rect =  Rect(50,50,50,50)
        ...
        fun setOverlayTransparentShape(shape: ShapeType): Builder {
