...
public class ShadowRelativeLayout extends RelativeLayout implements View.OnClickListener, Animation.AnimationListener {
    ...
    private void init(AttributeSet set) {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(() -> {
            if (first && animate) {
                ...
                animation.setAnimationListener(ShadowRelativeLayout.this);
                if (interpolate) {
    ...
    public void onClick(View v) {
        ...
        if (parent instanceof ShadowRelativeLayout && transferClick) {
            ShadowRelativeLayout complexView = (ShadowRelativeLayout) parent;
