...
enum class CardEnum(val cardName: String, @DrawableRes val icon: Int,val  startWith: String, val length: String) {

    AmericanExpress("American Express", R.drawable.payment_ic_amex, "5392", "16"),
