...
import co.yap.yapcore.helpers.screenutils.ScreenUtils
...
class BubbleMessageView : ConstraintLayout {
    ...
    private var imageViewClose: CoreButton? = null
    ...
    private fun inflateXML() {
        itemView = inflate(context, R.layout.hint_desc_box, this)
    }

    private fun bindViews() {
        imageViewClose = findViewById(R.id.btnNext)
        textViewTitle = findViewById(R.id.tvTitle)
        textViewPage = findViewById(R.id.tvCount)
