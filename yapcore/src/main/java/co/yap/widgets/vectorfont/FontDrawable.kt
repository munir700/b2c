...
class FontDrawable(context: Context, faIconRes: Int, isSolid: Boolean, isBrand: Boolean) : Drawable() {
    ...
    private fun init(context: Context, faIconRes: Int, isSolid: Boolean, isBrand: Boolean) {
        ...
        if (isSolid) {
            tf = FontCache[context, FontCache.FA_FONT_SOLID]
        } else if (isBrand) {
            tf = FontCache[context, FontCache.FA_FONT_BRANDS]
        } else {
            tf = FontCache[context, FontCache.FA_FONT_REGULAR]
        }
