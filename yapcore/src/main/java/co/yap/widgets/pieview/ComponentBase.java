...
public abstract class ComponentBase {
     ...
     */
    protected float mTextSize = UtilsPieView.convertDpToPixel(10f);
    ...
    public void setXOffset(float xOffset) {
        mXOffset = UtilsPieView.convertDpToPixel(xOffset);
    }
    ...
    public void setYOffset(float yOffset) {
        mYOffset = UtilsPieView.convertDpToPixel(yOffset);
    }
    ...
    public void setTextSize(float size) {
        ...
        mTextSize = UtilsPieView.convertDpToPixel(size);
    }
