...
public abstract class PieRadarChartBase<T extends ChartData<? extends IDataSet<? extends Entry>>>
    ...
    public void calculateOffsets() {
                ...
                case VERTICAL: {
                    ...
                    if (mLegend.getHorizontalAlignment() == Legend.LegendHorizontalAlignment.LEFT
                        ...
                        if (mLegend.getVerticalAlignment() == Legend.LegendVerticalAlignment.CENTER) {
                            ...
                            final float spacing = UtilsPieView.convertDpToPixel(13f);

                            xLegendOffset = fullLegendWidth + spacing;

                        } else {
                            // this is the space between the legend and the chart
                            float spacing = UtilsPieView.convertDpToPixel(8f);
                            ...
                            float minOffset = UtilsPieView.convertDpToPixel(5f);
        ...
        float minOffset = UtilsPieView.convertDpToPixel(mMinOffset);
    ...
    public void setRotationAngle(float angle) {
        ...
        mRotationAngle = UtilsPieView.getNormalizedAngle(mRawRotationAngle);
    }
