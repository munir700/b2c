...
public abstract class AxisRenderer extends Renderer {
    ...
    protected void computeAxisValues(float min, float max) {
        ...
        double interval = UtilsPieView.roundToNextSignificant(rawInterval);
        ...
        // Normalize interval
        double intervalMagnitude = UtilsPieView.roundToNextSignificant(Math.pow(10, (int) Math.log10(interval)));
        ...
        if (mAxis.isForceLabelsEnabled()) {
            ...
            double last = interval == 0.0 ? 0.0 : UtilsPieView.nextUp(Math.floor(yMax / interval) * interval);
