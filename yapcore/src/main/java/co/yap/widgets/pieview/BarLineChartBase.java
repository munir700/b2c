...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
     ...
     */
    protected ViewTreeObserver.OnDrawListener mDrawListener;
    /**
     ...
     * @param drawListener
     */
    public void setOnDrawListener(ViewTreeObserver.OnDrawListener drawListener) {
     ...
     * @return
     */
    public ViewTreeObserver.OnDrawListener getDrawListener() {
