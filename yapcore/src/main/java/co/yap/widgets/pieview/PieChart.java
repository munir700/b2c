...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    public void setCenterTextSize(float sizeDp) {
        ((PieChartRenderer) mRenderer).getPaintCenterText().setTextSize(
                UtilsPieView.convertDpToPixel(sizeDp));
    }
    ...
    public void setCenterTextOffset(float x, float y) {
        mCenterTextOffset.x = UtilsPieView.convertDpToPixel(x);
        mCenterTextOffset.y = UtilsPieView.convertDpToPixel(y);
    }
    ...
    public void setEntryLabelTextSize(float size) {
        ((PieChartRenderer) mRenderer).getPaintEntryLabels().setTextSize(UtilsPieView.convertDpToPixel(size));
    }
