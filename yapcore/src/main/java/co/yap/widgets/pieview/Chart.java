...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
    ...
    protected void init() {
        ...
        UtilsPieView.init(getContext());
        mMaxHighlightDistance = UtilsPieView.convertDpToPixel(500f);
        ...
        mInfoPaint.setTextSize(UtilsPieView.convertDpToPixel(12f));
    ...
    protected void setupDefaultFormatter(float min, float max) {
        ...
        int digits = UtilsPieView.getDecimals(reference);
    ...
    public void setMaxHighlightDistance(float distDp) {
        mMaxHighlightDistance = UtilsPieView.convertDpToPixel(distDp);
    }
    ...
    public void setExtraTopOffset(float offset) {
        mExtraTopOffset = UtilsPieView.convertDpToPixel(offset);
    }
    ...
    public void setExtraRightOffset(float offset) {
        mExtraRightOffset = UtilsPieView.convertDpToPixel(offset);
    }
    ...
    public void setExtraBottomOffset(float offset) {
        mExtraBottomOffset = UtilsPieView.convertDpToPixel(offset);
    }
    ...
    public void setExtraLeftOffset(float offset) {
        mExtraLeftOffset = UtilsPieView.convertDpToPixel(offset);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int size = (int) UtilsPieView.convertDpToPixel(50f);
