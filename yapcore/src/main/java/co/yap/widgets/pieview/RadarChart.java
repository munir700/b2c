...
public class RadarChart extends PieRadarChartBase<RadarData> {
    ...
    protected void init() {
        ...
        mWebLineWidth = UtilsPieView.convertDpToPixel(1.5f);
        mInnerWebLineWidth = UtilsPieView.convertDpToPixel(0.75f);
...
//            mYAxisRenderer.computeAxis(mYAxis.mAxisMinimum, mYAxis.mAxisMaximum, mYAxis.isInverted());
    ...
    public int getIndexForAngle(float angle) {
        ...
        float a = UtilsPieView.getNormalizedAngle(angle - getRotationAngle());
    ...
    public void setWebLineWidth(float width) {
        mWebLineWidth = UtilsPieView.convertDpToPixel(width);
    }
    ...
    public void setWebLineWidthInner(float width) {
        mInnerWebLineWidth = UtilsPieView.convertDpToPixel(width);
    }
    ...
    protected float getRequiredBaseOffset() {
        return mXAxis.isEnabled() && mXAxis.isDrawLabelsEnabled() ?
                ...
                UtilsPieView.convertDpToPixel(10f);
    }
