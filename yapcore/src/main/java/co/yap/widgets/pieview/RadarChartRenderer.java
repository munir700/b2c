...
public class RadarChartRenderer extends LineRadarRenderer {
    ...
    public void drawValues(Canvas c) {
        ...
        float yoffset = UtilsPieView.convertDpToPixel(5f);
    ...
    protected void drawWeb(Canvas c) {
        ...
        for (int j = 0; j < labelCount; j++) {
            ...
            for (int i = 0; i < mChart.getData().getEntryCount(); i++) {
                ...
                UtilsPieView.getPosition(center, r, sliceangle * i + rotationangle, p1out);
                UtilsPieView.getPosition(center, r, sliceangle * (i + 1) + rotationangle, p2out);
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (Highlight high : indices) {
            ...
            UtilsPieView.getPosition(center,
    ...
    public void drawHighlightCircle(Canvas c,
        ...
        outerRadius = UtilsPieView.convertDpToPixel(outerRadius);
        innerRadius = UtilsPieView.convertDpToPixel(innerRadius);
        ...
        if (strokeColor != ColorTemplate.COLOR_NONE) {
            ...
            mHighlightCirclePaint.setStrokeWidth(UtilsPieView.convertDpToPixel(strokeWidth));
