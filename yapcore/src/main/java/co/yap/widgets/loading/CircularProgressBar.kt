package co.yap.widgets.loading
...
class CircularProgressBar(context: Context, attrs: AttributeSet? = null) : View(context, attrs) {
    ...
    var progressBarWidth: Float = 20f
        set(value) {
            field = value.dpToPx()
    ...
    var backgroundProgressBarWidth: Float = 5f
        set(value) {
            field = value.dpToPx()
...
//            }
    ...
    fun postIndeterminateModeHandler() {
...
//            postIndeterminateModeHandler()
            ...
            if (this@CircularProgressBar.progressDirectionIndeterminateMode.isToRight()) {
                //progressIndeterminateMode = progressMax
                setProgressWithAnimation(0f, DEFAULT_ANIMATION_DURATION)
            } else {
                setProgressWithAnimation(-100f, DEFAULT_ANIMATION_DURATION)
            }
        }
    }
...
//        Log.d("updateAngle asdas3>>", "$progressIndeterminateMode")
//        if (progressIndeterminateMode > -25f) {
//            progressIndeterminateMode = progressIndeterminateMode
//        } else {
//            val remaining = -25f - progressIndeterminateMode
//            val final = progressIndeterminateMode + (remaining * 2)
//            progressIndeterminateMode = final
//        }
//        Log.d("updateAngle asdas2>>", "$progressIndeterminateMode")
        val realProgress =
