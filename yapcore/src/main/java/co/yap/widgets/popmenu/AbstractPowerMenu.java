...
/**
 * AbstractPowerMenu is the abstract class of {@link PopupMenu} and {@link CustomPowerMenu}.
 *
 * <p>It implements basically almost things of the PopupMenu.
 *
 * <p>
 */
...
public abstract class AbstractPowerMenu<E, T extends MenuBaseAdapter>
  ...
  protected void initialize(Context context) {
    ...
    this.backgroundView = layoutInflater.inflate(R.layout.layout_popup_background, null);
    ...
    this.menuView = layoutInflater.inflate(R.layout.layout_popup_menu, null);
...
//DimensionUtilsKt.dip(context,10);
    contentViewPadding = DimensionUtilsKt.dip(context,10);
  ...
  /**
   * sets {@link View.OnTouchListener} manually for the outside of popup.
   *
   ...
   *
   * @param onBackgroundClickListener {@link View.OnClickListener}.
   */
  ...
  /**
   * gets the preference name of PopupMenu.
   *
  ...
  /** clears the preference name of PopupMenu. */
