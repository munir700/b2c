...
package co.yap.widgets.advrecyclerview.swipeable;
...
public interface SwipeableItemViewHolder {
     ...
     *               - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#RESULT_NONE}
     *               - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_LEFT}
     *               - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_UP}
     *               - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_RIGHT}
     *               - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_DOWN}
     *               - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#RESULT_CANCELED}
     */
     ...
     *                 - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_DEFAULT}
     *                 - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_MOVE_TO_ORIGIN}
     *                 - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_REMOVE_ITEM}
     *                 - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_MOVE_TO_SWIPED_DIRECTION}
     *                 - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_DO_NOTHING}
     */
     ...
     *               - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_LEFT}
     *               - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_RIGHT}
     */
     ...
     * @param amount Item swipe amount. Generally the range is [-1.0 .. 1.0] if the proportional amount mode is enabled, otherwise distance in pixels.
     *               In additionally, these special values can also be accepted;
     *               - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_TOP}
     *               - {@link co.yap.widgets.advrecyclerview.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_BOTTOM}
     */
