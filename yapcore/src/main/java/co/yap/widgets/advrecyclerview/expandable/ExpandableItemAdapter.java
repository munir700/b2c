...
package co.yap.widgets.advrecyclerview.expandable;
...
import co.yap.widgets.advrecyclerview.adapter.ItemIdComposer;
import co.yap.widgets.advrecyclerview.adapter.ItemViewTypeComposer;
...
public interface ExpandableItemAdapter<GVH extends RecyclerView.ViewHolder, CVH extends RecyclerView.ViewHolder> {
     ...
     * {@link co.yap.widgets.advrecyclerview.expandable.RecyclerViewExpandableItemManager#expandGroup(int)} method.
     *
     * @param groupPosition The position of the group item within the adapter's data set
    ...
    /**
     * Called when a group attempt to expand by user operation or by
     * {@link co.yap.widgets.advrecyclerview.expandable.RecyclerViewExpandableItemManager#collapseGroup(int)} method.
     *
     * @param groupPosition The position of the group item within the adapter's data set
