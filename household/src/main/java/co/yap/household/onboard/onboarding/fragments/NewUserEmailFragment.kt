...
import co.yap.household.databinding.FragmentNewUserEmailBinding
...
class NewUserEmailFragment : OnboardingChildFragment<FragmentNewUserEmailBinding,IEmail.ViewModel>() {
