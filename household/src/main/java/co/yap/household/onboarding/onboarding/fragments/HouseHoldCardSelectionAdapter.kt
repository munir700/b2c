...
class HouseHoldCardSelectionAdapter(context: Context, private val list: MutableList<Int>) :
    BaseBindingRecyclerAdapter<Int, RecyclerView.ViewHolder>(list) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is HouseHoldCardSelectionItemViewHolder) {
            holder.onBind(list[0], list[position], dimensions, onItemClickListener)
        }
    }
}