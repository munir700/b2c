package co.yap.household.onboarding.dashboard.main.activities
...
import co.yap.household.onboarding.dashboard.main.adaptors.HouseholdDashboardPagerAdaptor
import co.yap.household.onboarding.dashboard.main.interfaces.IHouseholdDashboard
import co.yap.household.onboarding.dashboard.main.viewmodels.HouseholdDashboardViewModel
...
class HouseholdDashboardActivity : BaseBindingActivity<IHouseholdDashboard.ViewModel>(),
    ...
    private fun setupPager() {
        val adapter = HouseholdDashboardPagerAdaptor(supportFragmentManager)
