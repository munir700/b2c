...
import com.digitify.identityscanner.camera.engine.action.CompletionCallback;
import com.digitify.identityscanner.camera.engine.mappers.Camera2Mapper;
import com.digitify.identityscanner.camera.engine.meter.MeterAction;
import com.digitify.identityscanner.camera.engine.meter.MeterResetAction;
...
import com.digitify.identityscanner.camera.internal.utils.ImageHelper;
import com.digitify.identityscanner.camera.internal.utils.WorkerHandler;
import com.digitify.identityscanner.camera.picture.Full2PictureRecorder;
import com.digitify.identityscanner.camera.picture.Snapshot2PictureRecorder;
...
public class Camera2Engine extends CameraEngine implements ImageReader.OnImageAvailableListener,
    ...
    private final Camera2Mapper mMapper = Camera2Mapper.Companion.get();
    ...
    protected void onTakePictureSnapshot(@NonNull final PictureResult.Stub stub,
        ...
        if (doMetering) {
            ...
            Action action = Actions.INSTANCE.timeout(METER_TIMEOUT, createMeterAction(null));
    ...
    public void startAutoFocus(@Nullable final Gesture gesture, @NonNull final PointF point) {
        ...
        mHandler.run(new Runnable() {
            ...
            public void run() {
                ...
                Action wrapper = Actions.INSTANCE.timeout(METER_TIMEOUT, action);
