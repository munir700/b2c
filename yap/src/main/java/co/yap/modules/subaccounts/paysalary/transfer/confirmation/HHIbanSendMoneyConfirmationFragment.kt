...
class HHIbanSendMoneyConfirmationFragment:
    ...
    override fun getToolBarTitle() = Strings.screen_iban_send_money_confirmation_display_text_transfer_completed
    ...
    private fun onClick(id: Int) {
        when (id) {
            R.id.tv_do_it_later -> startFragment(HHProfileFragment::class.java.name)
        }
    }
}