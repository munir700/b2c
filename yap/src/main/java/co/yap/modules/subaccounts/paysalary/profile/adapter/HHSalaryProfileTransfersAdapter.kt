...
class HHSalaryProfileTransfersAdapter(internal var transactionData: Map<String?, List<Transaction>>) :
    BaseExpandableRVAdapter<Transaction, HHSalaryTransactionChildItemVM, AbstractExpandableItemViewHolder<Transaction, HHSalaryTransactionChildItemVM>
            , HomeTransactionListData, HHSalaryTransactionGroupItemVM, HHSalaryProfileTransfersAdapter.GroupViewHolder>() {
    init {
    ...
    override fun getChildViewHolder(
        view: View,
        viewModel: HHSalaryTransactionChildItemVM,
    ...
    override fun getGroupViewHolder(
        view: View,
        viewModel: HHSalaryTransactionGroupItemVM,
        mDataBinding: ViewDataBinding,
        viewType: Int
    ) =
        GroupViewHolder(
    ...
    override fun onBindChildViewHolder(
        holder: AbstractExpandableItemViewHolder<Transaction, HHSalaryTransactionChildItemVM>,
        groupPosition: Int,
        childPosition: Int,
        viewType: Int
    ) {
    ...
    override fun getGroupViewModel(viewType: Int) =
        HHSalaryTransactionGroupItemVM()
    override fun getGroupVariableId() = BR.viewModel
    override fun getChildViewModel(viewType: Int) =
        HHSalaryTransactionChildItemVM()
    ...
    class GroupViewHolder(
        ...
        viewModel: HHSalaryTransactionGroupItemVM,
        mDataBinding: ViewDataBinding
    ) : AbstractExpandableItemViewHolder<HomeTransactionListData, HHSalaryTransactionGroupItemVM>(
        view,
        viewModel,
        mDataBinding
