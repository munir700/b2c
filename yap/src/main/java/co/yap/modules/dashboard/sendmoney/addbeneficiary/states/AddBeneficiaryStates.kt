package co.yap.modules.dashboard.sendmoney.addbeneficiary.states
...
class AddBeneficiaryStates(context: Context) : BaseState(), IAddBeneficiary.State {
    ...
    override var flagDrawableResId: Int = -1
        set(value) {
            field = value
            notifyPropertyChanged(co.yap.BR.flagDrawableResId)
        }
    ...
    override var valid: Boolean = false
        set(value) {
            field = value
            notifyPropertyChanged(co.yap.BR.valid)
        }
