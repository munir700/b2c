...
//        })
    ...
    override fun getNotifications(
        ...
        if (accountInfo.getUserAccessRestrictions()[0] == UserAccessRestriction.ACCOUNT_INACTIVE ||
            accountInfo.getUserAccessRestrictions()[0] == UserAccessRestriction.OTP_BLOCKED ||
            accountInfo.getUserAccessRestrictions()[0] == UserAccessRestriction.EID_EXPIRED ||
            accountInfo.getUserAccessRestrictions()[0] == UserAccessRestriction.NONE
        ) {
            list.add(
                HomeNotification(
                    id = "5",
                    description = "Some of your card's features are temporarily disabled. Get in touch with us at +971 600551214 for assistance.",
