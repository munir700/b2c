...
class WidgetAdapter(
    ...
    BaseExpandableRVAdapter<Transaction, SearchTransactionChildItemVM, WidgetAdapter.ChildViewHolder, HomeTransactionListData, SearchTransactionGroupItemVM, WidgetAdapter.GroupViewHolder>() {
