...
class CardOnTheWayViewModel(application: Application) :
    ...
    override fun onCreate() {
        ...
        bottomSheetItems.add(CoreBottomSheetData(-1, "", "I am a homemaker"))
        bottomSheetItems.add(CoreBottomSheetData(-1, "", "I am retired"))
        bottomSheetItems.add(CoreBottomSheetData(-1, "", "I am a pensioner"))
        bottomSheetItems.add(CoreBottomSheetData(-1, "", "Other"))
