...
import com.yap.core.extensions.clickableSpan
...
import com.yap.uikit.widgets.dialerpad.OnSecureCodeListener
import com.yap.yappakistan.BR
import com.yap.yappakistan.R
import com.yap.yappakistan.databinding.FragmentPasscodeBinding
...
class PasscodeFragment :
    ...
    private fun addObservers() {
        viewModel.viewState.passcodeError.observe(this, Observer{
            it?.let {
                if (it.isBlank()) {
